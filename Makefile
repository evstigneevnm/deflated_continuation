...
STABILITY_ANALYSIS_HEADERS = source/stability/analysis/stability_point_result.h source/stability/analysis/spectrum_classifier.h source/stability/analysis/spectrum_scan_aggregator.h source/stability/analysis/eigenvector_rank_aggregator.h source/stability/analysis/eigensolver_adapter.h source/stability/analysis/dimension_guarded_eigensolver.h source/stability/analysis/matrix_free_stability_config.h source/stability/analysis/matrix_free_stability_configuration.h source/stability/analysis/matrix_free_stability_solver.h source/stability/analysis/matrix_free_stability_scan.h source/stability/analysis/initial_vector_policy.h source/stability/analysis/detail/vector_workspace.h source/stability/analysis/transition_state_alignment.h source/stability/analysis/stability_evaluator.h source/stability/analysis/stability_transition_refiner.h source/stability/stability_analysis.hpp
...
test_scalar_affine_inverse_cpu_omp.bin: source/models/tests/test_scalar_affine_inverse.cpp $(CIRCLE_MODEL_HEADERS) $(STAR_SHAPED_MODEL_HEADERS) $(SCFD_VECTOR_OPS_HEADERS)
...
test_scalar_affine_inverse_cuda.bin: source/models/tests/test_scalar_affine_inverse.cpp $(CIRCLE_MODEL_HEADERS) $(STAR_SHAPED_MODEL_HEADERS) $(SCFD_VECTOR_OPS_HEADERS) source/common/cuda_init_scfd.h $(BUILD_DIR)/gpu_reduction_ogita_kernels.o
...
test_bratu_stability_operators_cpu_omp.bin: source/models/bratu/test_bratu_stability_operators.cpp $(BRATU_MODEL_HEADERS) source/stability/eigensolvers/host_dense_operator_eigensolver.h $(HOST_SMALL_DENSE_HEADERS) $(SCFD_VECTOR_OPS_HEADERS)
...
test_stability_analysis_pipeline_cuda.bin: source/stability/tests/test_stability_analysis_pipeline_cuda.cu source/common/cuda_init_scfd.h $(STABILITY_ANALYSIS_HEADERS) $(SCFD_VECTOR_OPS_HEADERS) $(BUILD_DIR)/gpu_reduction_ogita_kernels.o
	$(NVCC) $(NVCCFLAGS) --extended-lambda $(ICUDA) $(IPROJECT) source/stability/tests/test_stability_analysis_pipeline_cuda.cu $(BUILD_DIR)/gpu_reduction_ogita_kernels.o $(LIBS1) -o $(BUILD_DIR)/test_stability_analysis_pipeline_cuda.bin 2>$(RESULTS)

test_spectrum_scan_aggregator.bin: source/stability/tests/test_spectrum_scan_aggregator.cpp source/stability/analysis/spectrum_scan_aggregator.h source/stability/analysis/spectrum_classifier.h source/stability/eigensolvers/eigensolver_result.h
...
test_eigenvector_rank_aggregator_cpu_omp.bin: source/stability/tests/test_eigenvector_rank_aggregator.cpp source/stability/analysis/eigenvector_rank_aggregator.h source/stability/analysis/detail/vector_workspace.h source/stability/eigensolvers/ritz_recovery.h source/stability/eigensolvers/eigensolver_result.h $(SCFD_SERIAL_VECTOR_OPS_HEADERS) $(NMFD_KRYLOV_HEADERS)
...
test_linear_solve_recovery.bin: source/numerical_algos/lin_solvers/tests/test_linear_solve_recovery.cpp source/numerical_algos/lin_solvers/linear_solve_recovery.h
...
KS1D_operator_cpu_omp.bin: source/models/KS_1D/test_KS1D_operator.cpp $(KS1D_MODEL_HEADERS) $(AFFINE_PRECONDITIONER_HEADERS) $(SCFD_VECTOR_OPS_HEADERS) $(FFT_FACADE_HEADERS)
...
KS1D_operator_cuda.bin: source/models/KS_1D/test_KS1D_operator.cpp $(KS1D_MODEL_HEADERS) $(AFFINE_PRECONDITIONER_HEADERS) $(SCFD_VECTOR_OPS_HEADERS) $(FFT_FACADE_HEADERS) source/common/cuda_init_scfd.h $(BUILD_DIR)/gpu_reduction_ogita_kernels.o
...
KS1D_full_operator_cpu_omp.bin: source/models/KS_1D/test_KS1D_full_operator.cpp $(KS1D_FULL_MODEL_HEADERS) $(AFFINE_PRECONDITIONER_HEADERS) $(SCFD_VECTOR_OPS_HEADERS) $(FFT_FACADE_HEADERS)
...
KS1D_full_operator_cuda.bin: source/models/KS_1D/test_KS1D_full_operator.cpp $(KS1D_FULL_MODEL_HEADERS) $(AFFINE_PRECONDITIONER_HEADERS) $(SCFD_VECTOR_OPS_HEADERS) $(FFT_FACADE_HEADERS) source/common/cuda_init_scfd.h $(BUILD_DIR)/gpu_reduction_ogita_kernels.o
