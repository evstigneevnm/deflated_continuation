...
test_KS2D_operator_cpu_omp.bin: source/models/KS_2D/test_KS2D_operator.cpp source/symmetry/fourier/translation_action.h $(KS2D_REFACTORED_HEADERS) $(RESIDUAL_DECOMPOSITION_TEST_HEADER)
...
test_KS2D_operator_cuda.bin: source/models/KS_2D/test_KS2D_operator.cpp source/symmetry/fourier/translation_action.h $(KS2D_REFACTORED_HEADERS) $(RESIDUAL_DECOMPOSITION_TEST_HEADER) source/common/cuda_init_scfd.h $(BUILD_DIR)/gpu_reduction_ogita_kernels.o
...
test_bratu_stability_operators_cpu_omp.bin: source/models/bratu/test_bratu_stability_operators.cpp $(BRATU_MODEL_HEADERS) $(RESIDUAL_DECOMPOSITION_TEST_HEADER) source/stability/eigensolvers/host_dense_operator_eigensolver.h $(HOST_SMALL_DENSE_HEADERS) $(SCFD_VECTOR_OPS_HEADERS)
...
KS1D_operator_cpu_omp.bin: source/models/KS_1D/test_KS1D_operator.cpp $(KS1D_MODEL_HEADERS) $(RESIDUAL_DECOMPOSITION_TEST_HEADER) $(AFFINE_PRECONDITIONER_HEADERS) $(SCFD_VECTOR_OPS_HEADERS) $(FFT_FACADE_HEADERS)
...
KS1D_operator_cuda.bin: source/models/KS_1D/test_KS1D_operator.cpp $(KS1D_MODEL_HEADERS) $(RESIDUAL_DECOMPOSITION_TEST_HEADER) $(AFFINE_PRECONDITIONER_HEADERS) $(SCFD_VECTOR_OPS_HEADERS) $(FFT_FACADE_HEADERS) source/common/cuda_init_scfd.h $(BUILD_DIR)/gpu_reduction_ogita_kernels.o
...
KS1D_full_operator_cpu_omp.bin: source/models/KS_1D/test_KS1D_full_operator.cpp $(KS1D_FULL_MODEL_HEADERS) $(RESIDUAL_DECOMPOSITION_TEST_HEADER) $(AFFINE_PRECONDITIONER_HEADERS) $(SCFD_VECTOR_OPS_HEADERS) $(FFT_FACADE_HEADERS)
...
KS1D_full_operator_cuda.bin: source/models/KS_1D/test_KS1D_full_operator.cpp $(KS1D_FULL_MODEL_HEADERS) $(RESIDUAL_DECOMPOSITION_TEST_HEADER) $(AFFINE_PRECONDITIONER_HEADERS) $(SCFD_VECTOR_OPS_HEADERS) $(FFT_FACADE_HEADERS) source/common/cuda_init_scfd.h $(BUILD_DIR)/gpu_reduction_ogita_kernels.o
