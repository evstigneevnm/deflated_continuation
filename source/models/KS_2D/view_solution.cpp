...
int main(int argc, char const *argv[])
{
    ...
    KS_2D_t *KS2D = new KS_2D_t(a_val, b_val, Nx, Ny, vec_ops_R, vec_ops_C, vec_ops, CUFFT_C2R);
    ...
    try
    {
        ...
        KS2D->write_solution(f_name_abs_pos, (vec&)b);
        std::cout << "wrote " << f_name_abs_pos << std::endl;
        KS2D->write_solution_plain(f_name_abs_dat, (vec&)b);
