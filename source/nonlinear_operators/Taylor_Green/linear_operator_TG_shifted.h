#ifndef __LINEAR_OPERATOR_TG_SHIFTED_H__
#define __LINEAR_OPERATOR_TG_SHIFTED_H__
...
class linear_operator_TG_shifted
{
public:    
    ...
    linear_operator_TG_shifted(VectorOperations* vec_ops_, NonlinearOperator* nonlin_op_): 
    vec_ops(vec_ops_),
    nonlin_op(nonlin_op_)
    {

    }
    ~linear_operator_TG_shifted()
    {
