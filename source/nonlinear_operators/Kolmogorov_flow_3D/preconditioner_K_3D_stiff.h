#ifndef __PRECONDITIONER_K_3D_STIFF_H__
#define __PRECONDITIONER_K_3D_STIFF_H__
...
class preconditioner_K_3D_stiff
{
public:
    typedef typename VectorOperations::scalar_type  T;
    typedef typename VectorOperations::vector_type  T_vec;

    preconditioner_K_3D_stiff(VectorOperations* vec_ops, NonlinearOperator* nonlin_op):
    vec_ops_(vec_ops), nonlin_op_(nonlin_op)
    {

    }

    ~preconditioner_K_3D_stiff()
    {
