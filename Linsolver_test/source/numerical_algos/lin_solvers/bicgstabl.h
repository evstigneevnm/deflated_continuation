...
public:
    ...
    {                
        ...
        {       
            ...
            bool    recalc_real_resid = !((resid_recalc_freq_ == 0)||
                                          ((monitor_.iters_performed()/basis_sz_+1) % resid_recalc_freq_ != 0));
