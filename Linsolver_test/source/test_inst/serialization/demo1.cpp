...
int main(int argc, char const *argv[])
{
    ...
    typedef typename boost::archive::text_oarchive output;
    typedef typename boost::archive::text_iarchive input;
    // typedef typename boost::archive::binary_oarchive output;
    // typedef typename boost::archive::binary_iarchive input;
    // typedef typename boost::archive::basic_xml_oarchive output;
    // typedef typename boost::archive::basic_xml_iarchive input;
    ...
    std::string seri_file_name(project_dir + std::string("/") + std::string("bifurcation_diagram.dat"));
    ...
    {
        input ia(load_file);
        ia & BOOST_SERIALIZATION_NVP(*container1);
    }
