#ifndef __LINEAR_OPERATOR_KS_2D_SHIFTED_H__
#define __LINEAR_OPERATOR_KS_2D_SHIFTED_H__
...
class linear_operator_KS_2D_shifted
{
public:    
    ...
    linear_operator_KS_2D_shifted(VectorOperations* vec_ops_, NonlinearOperator* nonlin_op_): 
    vec_ops(vec_ops_),
    nonlin_op(nonlin_op_)
    {

    }
    ~linear_operator_KS_2D_shifted()
    {
