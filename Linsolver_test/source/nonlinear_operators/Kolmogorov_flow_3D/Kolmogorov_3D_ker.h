...
struct Kolmogorov_3D_ker
{
    ...
    void sinus_perturbation(int direction, TR magnitude_x, TR nx, TR phase_x, TR magnitude_y, TR ny, TR phase_y, TR magnitude_z, TR nz, TR phase_z, TR_vec u_x, TR_vec u_y, TR_vec u_z);
