#ifndef __PRECONDITIONER_K_3D_HOMOTOPY_H__
#define __PRECONDITIONER_K_3D_HOMOTOPY_H__
...
class preconditioner_K_3D_homotopy
{
public:
    typedef typename VectorOperations::scalar_type  T;
    typedef typename VectorOperations::vector_type  T_vec;

    preconditioner_K_3D_homotopy(NonlinearOperator*& nonlin_op_):
    nonlin_op(nonlin_op_)
    {

    }

    ~preconditioner_K_3D_homotopy()
    {
