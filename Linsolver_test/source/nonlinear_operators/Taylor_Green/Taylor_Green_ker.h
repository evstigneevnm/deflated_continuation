#ifndef __Taylor_Green_KER_H__
#define __Taylor_Green_KER_H__

/**
*   Axillary class of funcitons for Taylor-Green flow used in the Taylor_Green class.
...
struct Taylor_Green_ker
{
    ...
    void probe_physical_scalar(int3_t* coords,  TR_vec scalar, TR_vec res);
    void probe_physical_vector(int3_t* coords,  TR_vec vx, TR_vec vy, TR_vec vz, TR_vec res);
    void probe_spectral_scalar(int3_t* coords,  TR_vec scalar, TR_vec res);
    void probe_spectral_vector(int3_t* coords,  TR_vec vx, TR_vec vy, TR_vec vz, TR_vec res);
...
private:
    ...
    void calculate_cuda_grid()
    {
        ...
        printf("Taylor-Green template specialization class:\n");
        //1D
