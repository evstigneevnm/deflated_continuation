#ifndef __PRECONDITIONER_ABC_FLOW_SHIFTED_H__
#define __PRECONDITIONER_ABC_FLOW_SHIFTED_H__
...
class preconditioner_abc_flow_shifted
{
public:
    typedef typename vector_operations::scalar_type  T;
    typedef typename vector_operations::vector_type  T_vec;

    preconditioner_abc_flow_shifted(nonlinear_operator*& nonlin_op_):
    nonlin_op(nonlin_op_)
    {

    }

    ~preconditioner_abc_flow_shifted()
    {
