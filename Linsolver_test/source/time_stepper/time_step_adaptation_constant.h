...
class time_step_adaptation_constant: public time_step_adaptation<VectorOperations, Log>
{
public:
...
public:
    time_step_adaptation_constant(VectorOperations* vec_ops_p, Log* log_p, std::pair<T,T> time_interval_p = {0,1},  T dt_p = 0.0):
    parent_t(vec_ops_p, log_p, time_interval_p, dt_p)
    {}
    ...
    bool estimate_timestep(const T_vec& x_p, const T_vec& x_new_p, const T_vec& f_err_p)const
    {
