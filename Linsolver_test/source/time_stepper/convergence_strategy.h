#ifndef __CONVERGENCE_STRATEGY_TEMPORAL_H__
#define __CONVERGENCE_STRATEGY_TEMPORAL_H__
/**
*
...
*    5 - linsolver failed (for temporal integration)
*/
...
public:    
    ...
    bool check_convergence(nonlinear_operator* nonlin_op, T_vec& x, T lambda, T_vec& delta_x, int& result_status, bool lin_solver_converged = true)
    {
        ...
        log->info_f("nonlinear_operators::convergence: iteration %i, previous residual %le, current residual %le",iterations, (double)normFx, (double)normFx1);
