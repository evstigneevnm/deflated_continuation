...
#include <nonlinear_operators/Kuramoto_Sivashinskiy_2D/linear_operator_KS_2D_shifted.h>
#include <nonlinear_operators/Kuramoto_Sivashinskiy_2D/preconditioner_KS_2D_shifted.h>
...
int main(int argc, char const *argv[])
{
    ...
    using lin_op_shifted_t = nonlinear_operators::linear_operator_KS_2D_shifted<vec_ops_real_im, KS_2D_t>;
    using prec_shifted_t = nonlinear_operators::preconditioner_KS_2D_shifted<vec_ops_real_im, KS_2D_t, lin_op_shifted_t>;    
    ...
    if( (what_to_execute=='D')||(what_to_execute == 'E') )
    {
        typedef main_classes::deflation_continuation<
            vec_ops_real_im, files_real_im_t, log_t, monitor_t, KS_2D_t, 
    ...
    {
        typedef main_classes::stability_continuation<vec_ops_real_im, mat_vec_ops_t, files_real_im_t, log_t, monitor_t, KS_2D_t, lin_op_t, prec_t, lin_op_shifted_t, prec_shifted_t, numerical_algos::lin_solvers::bicgstabl, nonlinear_operators::system_operator, parameters_t> stability_t;
