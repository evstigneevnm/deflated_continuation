...
int main(int argc, char const *argv[])
{
    ...
    size_t Ny = N;
    size_t Nz = N;
    std::cout << "Using alpha = " << alpha << ", Reynolds 1 = " << Rey << ", Reynolds 2 = " << Rey2 << ", with discretization: " << Nx << "X" << Ny << "X" << Nz << ", and dim(Krylov) = " << m << std::endl;
    ...
    //file_ops->read_vector("x_1.dat", x0);
