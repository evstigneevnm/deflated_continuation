...
int main(int argc, char const *argv[])
{
    ...
    real norm_wight = std::sqrt(real(3*(Nx*Ny*Mz-1)));
    ...
    convergence_newton_t *conv_newton = new convergence_newton_t(vec_ops, log, newton_def_tol, newton_def_max_it, real(1) );
