...
#include <nonlinear_operators/abc_flow/linear_operator_abc_flow_shifted.h>
#include <nonlinear_operators/abc_flow/preconditioner_abc_flow_shifted.h>
...
int main(int argc, char const *argv[])
{
    ...
    typedef nonlinear_operators::linear_operator_abc_flow<
        vec_ops_t, abc_flow_t> lin_op_t;
    typedef nonlinear_operators::preconditioner_abc_flow<
        vec_ops_t, abc_flow_t, lin_op_t> prec_t;

    //linear operators and preconditioners with shifts
    using lin_op_shifted_t = nonlinear_operators::linear_operator_abc_flow_shifted<vec_ops_t, abc_flow_t>;
    using prec_shifted_t = nonlinear_operators::preconditioner_abc_flow_shifted<vec_ops_t, abc_flow_t, lin_op_shifted_t>;    
    ...
    files_t file_ops_vec( (vec_ops_t*) &vec_ops);    

    abc_flow_t abc(Nx, Ny, Nz, (vec_ops_real_t*) &vec_ops_R, (vec_ops_complex_t*) &vec_ops_C, (vec_ops_t*) &vec_ops, CUFFT_C2R);
    ...
    if( (what_to_execute=='D')||(what_to_execute == 'E') )
    {
        typedef main_classes::deflation_continuation<
            vec_ops_t, files_t, log_t, monitor_t, abc_flow_t, 
        ...
        deflation_continuation_t DC( (vec_ops_t*) &vec_ops, (files_t*) &file_ops_vec, (log_t*) &log,  (log_t*) &log_linsolver, (abc_flow_t*) &abc, (parameters_t*) &parameters);
        DC.set_parameters();
    ...
    {
        typedef main_classes::stability_continuation<vec_ops_t, mat_vec_ops_t, files_t, log_t, monitor_t, abc_flow_t, lin_op_t, prec_t, lin_op_shifted_t, prec_shifted_t, numerical_algos::lin_solvers::bicgstabl, nonlinear_operators::system_operator, parameters_t> stability_t;

        vec_ops_t vec_ops_small(m_Krylov, CUBLAS);
        mat_vec_ops_t mat_ops_small(m_Krylov, m_Krylov, CUBLAS);

        stability_t ST( (vec_ops_t*) &vec_ops, (mat_vec_ops_t*) &mat_vec_ops, (vec_ops_t*) &vec_ops_small, (mat_vec_ops_t*) &mat_ops_small, (files_t*) &file_ops_vec, (log_t*) &log, (log_t*) &log_linsolver, (abc_flow_t*) &abc, (parameters_t*) &parameters);
    ...
    {
        typedef main_classes::plot_diagram_to_pos<vec_ops_t, mat_vec_ops_t, files_t, log_t, monitor_t, abc_flow_t, lin_op_t, prec_t, numerical_algos::lin_solvers::bicgstabl, nonlinear_operators::system_operator, parameters_t> plot_diagram_t;       

        plot_diagram_t PD( (vec_ops_t*) &vec_ops, (files_t*) &file_ops_vec, (log_t*) &log, (log_t*) &log_linsolver, (abc_flow_t*) &abc, (parameters_t*) &parameters);
